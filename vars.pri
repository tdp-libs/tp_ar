...
SOURCES += src/AbstractBackgroundLayer.cpp
HEADERS += inc/tp_ar/AbstractBackgroundLayer.h

#We need a way to do this that works for both cmake and qmake.
android{
...
SOURCES += src/layers/ArKitBackgroundLayer.cpp
HEADERS += inc/tp_ar/layers/ArKitBackgroundLayer.h
}
